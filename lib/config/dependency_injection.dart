...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
/// [Login_driver] and [login_police_man]
...
initNotification() {
  ...
  if (!GetIt.I.isRegistered<GetAllNotificationsUseCase>()) {
    instance.registerLazySingleton<GetAllNotificationsUseCase>(
        () => GetAllNotificationsUseCase(instance<NotificationsRepo>()));
  }
  if (!GetIt.I.isRegistered<UpdateNotificationStatusUseCase>()) {
    instance.registerLazySingleton<UpdateNotificationStatusUseCase>(
        () => UpdateNotificationStatusUseCase(instance<NotificationsRepo>()));
  }
  if (!GetIt.I.isRegistered<DeleteAllNotificationsUseCase>()) {
    instance.registerLazySingleton<DeleteAllNotificationsUseCase>(
        () => DeleteAllNotificationsUseCase(instance<NotificationsRepo>()));
  }
  if (!GetIt.I.isRegistered<DeleteDriverNotificationsByIdUseCase>()) {
    instance.registerLazySingleton<DeleteDriverNotificationsByIdUseCase>(() =>
        DeleteDriverNotificationsByIdUseCase(instance<NotificationsRepo>()));
  }
...
disposeNotification() {
  ...
  if (GetIt.I.isRegistered<DeleteAllNotificationsUseCase>()) {
    instance.unregister<DeleteAllNotificationsUseCase>();
  }
  if (GetIt.I.isRegistered<DeleteDriverNotificationsByIdUseCase>()) {
    instance.unregister<DeleteDriverNotificationsByIdUseCase>();
  }
  if (GetIt.I.isRegistered<GetAllNotificationsUseCase>()) {
    instance.unregister<GetAllNotificationsUseCase>();
  }
  if (GetIt.I.isRegistered<UpdateNotificationStatusUseCase>()) {
    instance.unregister<UpdateNotificationStatusUseCase>();
  }
