class ApiConstants {
  ...
  static const String getListOfViolationsForPolice =
      '$baseUrl/rest/v1/rpc/get_list_of_violations_for_police';
  static const String sendVerificationCode =
      '$baseUrl/rest/v1/rpc/send_verification_code';
  static const String sendRequestUpdateProfile =
      '$baseUrl/rest/v1/rpc/send_request_update_profile';
}
