...
class ManagerColors {
  ...
  static const Color primaryColor = Color(0XFFCDAB35);

  /// ThemeData: colorScheme -> primary
  static const Color americanGold = Color(0XFFCEAD3B);

  /// ThemeData: colorScheme -> onPrimary
  static const Color philippineGray = Color(0XFF978D8D);
  ...
  /// Used in [snackBarTheme]
  static const Color successColor = Color(0XFF4F8F48);
  ...
  static const Color disabledColor = Color.fromRGBO(83, 79, 79, .25);
  ...
  static const Color lotion = Color(0XFFFBFBFB);
